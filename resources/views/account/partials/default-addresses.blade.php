<div class="flex flex-wrap gap-5 max-sm:flex-col">
    <div class="flex-1">
        ...
        <div class="text-gray-700" v-if="data.customer.addresses.find(a => a.default_billing == true)">
            ...
            @isset($edit)
                <a :href="'/account/address/'+billing.id | url" class="underline hover:no-underline text-neutral">@lang('Change billing address')</a>
            @endisset
        </div>
    ...
    <div class="flex-1">
        ...
        <div class="text-gray-700" v-if="data.customer.addresses.find(a => a.default_shipping == true)">
            ...
            @isset($edit)
                <a :href="'/account/address/'+shipping.id | url" class="underline hover:no-underline text-neutral">@lang('Change shipping address')</a>
            @endisset
        </div>
