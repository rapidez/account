...
@section('content')
    <div class="flex justify-center">
        <graphql-mutation before="checkPassword" after="loginIfSuccesful" redirect="/account" query="mutation { createCustomerV2 ( input: changes ) { customer { firstname lastname email } } }">
