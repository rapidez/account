        ...
        <div v-if="data">
            <div class="divide-y">
                <x-rapidez::product-table v-for="product in data.customer.orders.items[0].items">
                    ...
                    <x-slot:price>@{{ window.price(product.product_sale_price.value) }}</x-slot:price>
            ...
            <div class="bg rounded p-6 mt-6">
                ...
                <dl class="space-y-6 border-t pt-5 xl:*:w-1/3">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd>@{{ window.price(data.customer.orders.items[0].total.shipping_handling.total_amount.value) }}</dd>
                    </div>
                    <div class="flex justify-between">
