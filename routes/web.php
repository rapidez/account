...
Route::middleware('web')->group(function () {
    ...
    Route::view('login?redirect', 'rapidez::account.login')->name('login'); // Because Laravel expects a "login" route
    ...
    Route::get('.well-known/change-password', fn () => redirect(route('account.edit')));
});
